	...
	$lookups = [
		...
		'event_decision_table' => [
			'outcomes_expected_lookup' => [
				'parent_table' => 'event_outcomes_expected_table',
				'parent_pk_field' => 'id',
				'parent_caption' => '`event_outcomes_expected_table`.`outcomes_expected_str`',
				'parent_from' => '`event_outcomes_expected_table` LEFT JOIN `event_table` as event_table1 ON `event_table1`.`id`=`event_outcomes_expected_table`.`event_lookup` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'meetings_table' => [
			'visiting_card_lookup' => [
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`visiting_card_table`.`id`',
				'parent_from' => '`visiting_card_table` LEFT JOIN `user_table` as user_table1 ON `user_table1`.`id`=`visiting_card_table`.`given_by` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'meetings_agenda_table' => [
			'meeting_lookup' => [
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`meetings_table`.`meetings_str`',
				'parent_from' => '`meetings_table` LEFT JOIN `visiting_card_table` as visiting_card_table1 ON `visiting_card_table1`.`id`=`meetings_table`.`visiting_card_lookup` LEFT JOIN `event_table` as event_table1 ON `event_table1`.`id`=`meetings_table`.`event_lookup` ',
				'filterers' => [],
				'custom_query' => 'SELECT `meetings_table`.`id`, `meetings_table`.`meetings_str` FROM `meetings_table` LEFT JOIN `visiting_card_table` as visiting_card_table1 ON `visiting_card_table1`.`id`=`meetings_table`.`visiting_card_lookup` LEFT JOIN `event_table` as event_table1 ON `event_table1`.`id`=`meetings_table`.`event_lookup` ORDER BY 2',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false,
			],
		...
		'meetings_decision_table' => [
			'agenda_lookup' => [
				'parent_table' => 'meetings_agenda_table',
				'parent_pk_field' => 'id',
				'parent_caption' => '`meetings_agenda_table`.`meetings_agenda_str`',
				'parent_from' => '`meetings_agenda_table` LEFT JOIN `meetings_table` as meetings_table1 ON `meetings_table1`.`id`=`meetings_agenda_table`.`meeting_lookup` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
